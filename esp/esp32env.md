...
> 📷 *安装界面示意：扩展商店搜索结果页*
* ![安装界面示意：扩展商店搜索结果页](../images/opt_20260715_04.png ':size=400')
---
...
![安装管理器界面示意](../images/opt_20260715_05.png ':size=400')

3. 选择 **简易安装**（Express Installation）模式。
4. 在版本选择下拉框中，选取 **V5.5** 版本。

![安装管理器界面示意](../images/opt_20260715_07.png ':size=400')

5. 点击安装，耐心等待所有组件下载和配置完成（过程可能需要较长时间，请保持网络畅通）。

> 📷 *安装管理器界面示意*
* ![安装管理器界面示意](../images/opt_20260715_03.png ':size=400')
---
...
![安装管理器界面示意](../images/opt_20260715_06.png ':size=400')
...
* ![烧录波特率设置界面示意](../images/opt_20260715_02.png ':size=400')
### 4.2 设置串口监视器波特率（Monitor Baud Rate）

- 在搜索框中输入 `monitor`。
- 找到 **Monitor Baud Rate** 选项，将其值修改为 **74880**（ESP8266 / ESP32 默认启动日志波特率）。

* ![串口波特率设置界面示意](../images/opt_20260715_01.png ':size=400')
---
